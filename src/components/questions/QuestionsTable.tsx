...
import { parseInitialQuestionTableFilters } from "@/lib/parseQuestionTableSearchParams";
...
import { makeColumns, difficultyColor } from "./questionsTableColumns";
...
export default function QuestionsTable({ data, updatedDate }: { data: Question[]; updatedDate: string }) {
  ...
  const [columnFilters, setColumnFilters] = useState<ColumnFiltersState>(() =>
    parseInitialQuestionTableFilters(searchParams)
  );
